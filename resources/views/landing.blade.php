...
<body id="top" class="bg-stone-50 text-stone-900 font-sans antialiased selection:bg-emerald-500 selection:text-white pb-24 md:pb-0">
            ...
            <div class="max-w-5xl mx-auto px-4 sm:px-6">
                ...
                <div class="text-center max-w-3xl mx-auto">
                    ...
                    <div class="mt-6 sm:mt-8 flex flex-wrap items-center justify-center gap-3">
                        <a href="#inquiry" class="inline-flex items-center justify-center gap-1.5 px-5 py-2.5 rounded-xl text-sm font-semibold text-white bg-emerald-700 hover:bg-emerald-800 shadow-md shadow-emerald-700/20 active:scale-[0.98] transition">
                            <span>Inquire Now</span>
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 14l-7 7m0 0l-7-7m7 7V3"/>
                            </svg>
                        </a>
                        <a href="tel:{{ $van['owner']['phone_tel'] }}" class="inline-flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-xl text-sm font-semibold text-stone-800 bg-white border border-stone-300 hover:bg-stone-50 active:scale-[0.98] transition">
            ...
            <div class="max-w-5xl mx-auto px-4 sm:px-6">
                ...
                <div class="bg-stone-50 rounded-2xl p-6 sm:p-8 border border-stone-200 flex flex-col md:flex-row gap-6 items-start justify-between">
                    ...
                    <div class="w-full md:w-auto shrink-0 bg-white p-5 rounded-xl border border-stone-200 text-center md:text-left">
                        ...
                        <a href="#inquiry" class="mt-4 inline-flex items-center justify-center px-4 py-2 rounded-lg text-xs font-semibold text-emerald-800 bg-emerald-50 border border-emerald-300 hover:bg-emerald-100 transition">
                            Get Quote
                        </a>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-3xl p-6 sm:p-10 md:p-12 border border-stone-200 shadow-sm">
                    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
                        ...
                        <div class="lg:col-span-6 text-center lg:text-left">
                            ...
                            <div class="mt-6 pt-5 border-t border-stone-100 flex flex-wrap items-center justify-center lg:justify-start gap-2.5">
                                <a href="#inquiry" class="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl font-bold text-xs sm:text-sm text-white bg-emerald-700 hover:bg-emerald-800 active:scale-95 shadow-sm transition">
                                    <span>Plan Trip</span>
                                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"/></svg>
                                </a>
                                <a href="tel:{{ $van['owner']['phone_tel'] }}" class="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl font-semibold text-xs sm:text-sm text-stone-700 bg-stone-100 hover:bg-stone-200 border border-stone-300 active:scale-95 transition">
        ...
        <section id="trips" class="py-14 sm:py-20 bg-stone-100/70 border-b border-stone-200/80">
            <div class="max-w-5xl mx-auto px-4 sm:px-6">
                ...
                <div class="mt-10 p-5 sm:p-6 rounded-2xl bg-emerald-800 text-emerald-50 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-md">
                    ...
                    <a href="#inquiry" class="inline-flex items-center justify-center gap-1.5 px-4 py-2 rounded-xl text-xs sm:text-sm font-bold bg-white text-emerald-900 hover:bg-emerald-50 active:scale-95 transition shrink-0">
                        <span>Book Trip</span>
                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"/></svg>
                    </a>
                </div>
            ...
            <div class="max-w-5xl mx-auto px-4 sm:px-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-6 lg:gap-8 items-start">
                    ...
                    <div class="md:col-span-5 bg-stone-50 rounded-2xl p-4 sm:p-6 lg:p-7 border border-stone-200 w-full min-w-0">
                        ...
                        {{-- Action Buttons --}}
                        <div class="mt-7 pt-6 border-t border-stone-200/80 flex items-center gap-2">
                            <a href="tel:{{ $van['owner']['phone_tel'] }}" class="flex-1 inline-flex items-center justify-center gap-1.5 px-3.5 py-2.5 rounded-xl font-bold text-xs sm:text-sm text-white bg-emerald-700 hover:bg-emerald-800 active:scale-[0.98] shadow-sm transition">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                                <span>Call</span>
                            </a>
                            <a href="{{ $van['owner']['messages_url'] }}" target="_blank" rel="noopener" class="flex-1 inline-flex items-center justify-center gap-1.5 px-3.5 py-2.5 rounded-xl font-bold text-xs sm:text-sm text-stone-800 bg-white border border-stone-300 hover:bg-stone-50 active:scale-[0.98] transition">
                    ...
                    <div id="inquiry" class="md:col-span-7 bg-white rounded-2xl p-4 sm:p-6 lg:p-7 border border-stone-200 shadow-sm w-full min-w-0">
                        ...
                        <div id="inquiry-form-container" class="mt-4 sm:mt-5 space-y-4">
                            ...
                            {{-- Direct One-Click Inquiry Actions (Compact 4-Action Grid) --}}
                            <div class="grid grid-cols-2 sm:grid-cols-4 gap-2 pt-2">
                                ...
                                <button 
                                    ...
                                    class="py-2.5 px-3 rounded-xl font-bold text-xs sm:text-sm text-white bg-blue-600 hover:bg-blue-700 active:scale-[0.98] shadow-sm flex items-center justify-center gap-1.5 transition cursor-pointer"
                                >
                                    <svg class="w-4 h-4 shrink-0 text-white fill-current" viewBox="0 0 24 24"><path d="M12 2C6.477 2 2 6.145 2 11.258c0 2.91 1.455 5.514 3.734 7.205V22l3.37-1.85c.915.253 1.888.39 2.896.39 5.523 0 10-4.145 10-9.282C22 6.145 17.523 2 12 2zm1.04 12.51l-2.656-2.833-5.183 2.833 5.7-6.052 2.723 2.833 5.117-2.833-5.701 6.052z"/></svg>
                                    <span>Messenger</span>
                                </button>
                                ...
                                <button 
                                    ...
                                    class="py-2.5 px-3 rounded-xl font-bold text-xs sm:text-sm text-stone-800 bg-stone-50 hover:bg-stone-100 border border-stone-300 active:scale-[0.98] flex items-center justify-center gap-1.5 transition cursor-pointer"
                                >
                                ...
                                <button 
                                    ...
                                    class="py-2.5 px-3 rounded-xl font-semibold text-xs sm:text-sm text-emerald-800 bg-emerald-50 hover:bg-emerald-100 border border-emerald-200 active:scale-[0.98] flex items-center justify-center gap-1.5 transition cursor-pointer"
                                >
                                ...
                                <a 
                                    href="tel:{{ $van['owner']['phone_tel'] }}"
                                    class="py-2.5 px-3 rounded-xl font-semibold text-xs sm:text-sm text-stone-700 bg-white hover:bg-stone-50 border border-stone-200 active:scale-[0.98] flex items-center justify-center gap-1.5 transition text-center"
                                >
                            ...
                            <div class="bg-white rounded-2xl max-w-md w-full p-5 sm:p-6 text-center shadow-2xl border border-stone-200 animate-in fade-in zoom-in duration-200 max-h-[90vh] overflow-y-auto">
                                ...
                                <div class="mt-5 flex flex-col items-center gap-2">
                                    <a 
                                        ...
                                        target="_blank" 
                                        rel="noopener"
                                        class="inline-flex items-center justify-center gap-2 py-2 px-5 rounded-xl font-bold text-sm text-white bg-blue-600 hover:bg-blue-700 active:scale-[0.98] transition shadow-sm"
                                    >
    ...
    <div class="fixed bottom-0 inset-x-0 z-40 bg-white/95 backdrop-blur border-t border-stone-200 p-2 sm:hidden shadow-lg">
        <div class="flex items-center justify-center gap-2 max-w-sm mx-auto">
            <a href="tel:{{ $van['owner']['phone_tel'] }}" class="flex-1 inline-flex items-center justify-center gap-1 py-2 px-3 rounded-xl bg-emerald-700 text-white font-bold text-xs shadow-sm active:scale-95 transition">
                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                <span>Call</span>
            </a>
            <a href="{{ $van['owner']['messenger_url'] }}" target="_blank" rel="noopener" class="flex-1 inline-flex items-center justify-center gap-1 py-2 px-3 rounded-xl bg-blue-600 text-white font-bold text-xs shadow-sm active:scale-95 transition">
                <svg class="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24"><path d="M12 2C6.477 2 2 6.145 2 11.258c0 2.91 1.455 5.514 3.734 7.205V22l3.37-1.85c.915.253 1.888.39 2.896.39 5.523 0 10-4.145 10-9.282C22 6.145 17.523 2 12 2zm1.04 12.51l-2.656-2.833-5.183 2.833 5.7-6.052 2.723 2.833 5.117-2.833-5.701 6.052z"/></svg>
                <span>Messenger</span>
            </a>
            <a href="#inquiry" class="inline-flex items-center justify-center p-2 rounded-xl bg-stone-50 text-stone-700 border border-stone-200 text-xs font-semibold active:scale-95 transition" title="Inquiry Form">
